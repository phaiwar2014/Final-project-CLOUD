...
import { createPart } from "../graphql/mutations";
const client = generateClient();
export default function PartCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPart.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PartCreateForm")}
      {...rest}
    >
      <TextField
        label="Category key"
