...
export default function BookingUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCarBrand(cleanValues.carBrand);
    setCarYear(cleanValues.carYear);
    setLicensePlate(cleanValues.licensePlate);
    setMileage(cleanValues.mileage);
    setSelectedItems(cleanValues.selectedItems);
    ...
    setActualMileage(cleanValues.actualMileage);
    setErrors({});
  };
